    ...
    try {
      ...
      setLista([
        ...lista,
        {
          id: novo.id,
          nome: novo.produto,
          fornecedor: "Seu Fornecedor",
          id_fornecedor: 1,
          preco: novo.valor_produto,
          estoque: 0,
        },
      ]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <button
            onClick={() => setShowNovoProdutoModal(true)}
            ...
            <form onSubmit={handleNovoProduto} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={formProduto.valor_produto}
                  onChange={(e) =>
                    setFormProduto({
                      ...formProduto,
              ...
              <div>
                ...
                <input
                  type="text"
                  value={formProduto.tipo_embalagem}
                  onChange={(e) =>
                    setFormProduto({
                      ...formProduto,
