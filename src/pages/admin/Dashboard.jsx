...
export default function AdminDashboard() {
  ...
  async function carregarEstatisticas() {
    try {
      ...
      // Gráfico de tendência de pedidos (últimos 7 dias) - Dados reais
      ...
      // Top 5 lojas por valor total de pedidos
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Grid 2 colunas: Gráfico + Top Lojas */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Gráfico de Tendência - 2/3 */}
